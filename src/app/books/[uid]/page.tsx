...
export default async function Page({ params }: { params: Params }) {
  ...
  const page = await client
    ...
    const morePublications = await client.getAllByType('books', {
      filters: [
        prismic.filter.not('my.books.uid', params.uid)
      ],
      fetch: 'books.title'
    })
  return (
    <div className='py-12 md:gap-12 grid grid-cols-12 items-start'>
      <div className="col-span-full md:col-span-8">
        <div className="p-content">
          ...
          <PrismicLink href="/books" className="text-grey-400 hover:text-grey-700 inline-flex justify-between gap-2 transition-colors mb-4">
      ...
      <div className="col-span-full md:col-span-4 pr-content">
        ...
        {morePublications.length > 0 && (
          <PublicationSidebarList items={morePublications} title="More Books" />
        )}
      </div>
    </div>
  )
